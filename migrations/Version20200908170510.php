 ...
 */
final class Version20200908170510 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE figures ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE figures DROP created_at, DROP updated_at');
    }
}
