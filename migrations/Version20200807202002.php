 ...
 */
final class Version20200807202002 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX user_name_2 ON client');
        $this->addSql('DROP INDEX email ON client');
        $this->addSql('DROP INDEX email_2 ON client');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX user_name_2 ON client (user_name)');
        $this->addSql('CREATE UNIQUE INDEX email ON client (email)');
        $this->addSql('CREATE UNIQUE INDEX email_2 ON client (email)');
    }
}
