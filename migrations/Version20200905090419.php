 ...
 */
final class Version20200905090419 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image DROP id_figure');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD id_figure INT NOT NULL');
    }
}
